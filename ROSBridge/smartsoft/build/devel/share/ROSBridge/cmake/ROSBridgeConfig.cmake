...
if("TRUE" STREQUAL "TRUE")
  set(ROSBridge_SOURCE_PREFIX /home/lmartinez/SOFTWARE/smartsoft-ace-mdsd-v3/repos/Testing Components/ROSBridge/smartsoft)
  set(ROSBridge_DEVEL_PREFIX /home/lmartinez/SOFTWARE/smartsoft-ace-mdsd-v3/repos/Testing Components/ROSBridge/smartsoft/build/devel)
  ...
  set(ROSBridge_INSTALL_PREFIX /home/lmartinez/SOFTWARE/smartsoft)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ROSBridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lmartinez/SOFTWARE/smartsoft-ace-mdsd-v3/repos/Testing Components/ROSBridge/smartsoft/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ROSBridge_NUM_DUMMY_TARGETS)
      set(ROSBridge_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ROSBridge::wrapped-linker-option${ROSBridge_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ROSBridge_NUM_DUMMY_TARGETS "${ROSBridge_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ROSBridge::wrapped-linker-option${ROSBridge_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ROSBridge_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lmartinez/SOFTWARE/smartsoft-ace-mdsd-v3/repos/Testing Components/ROSBridge/smartsoft/build/devel/lib;/opt/ros/kinetic/lib)
