...
CTestImpl::CTestImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

CTestImpl::CTestImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
...
int CTestImpl::startComponentInfrastructure(void)
{
...
void CTestImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void CTestImpl::cleanUpComponentResources()
{
