...
//--------------------------------------------------------------------------
#ifndef _TEST_CORE_HH
#define _TEST_CORE_HH
...
#include <TestObserverInterface.hh>
...
private:
	...
	std::list<TestObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(TestObserverInterface *observer);
	void detach_interaction_observer(TestObserverInterface *observer);

public:
	TestCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~TestCore();
